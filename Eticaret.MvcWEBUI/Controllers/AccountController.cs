...
namespace Eticaret.MvcWEBUI.Controllers
{
    ...
    {
        private UserManager<CustomIdentityUser> _userManager; //kullanıcı hesaplarını yönetmek adına.
        private RoleManager<CustomIdentityRole> _roleManager; //rolleri yönetmek adına.
        private SignInManager<CustomIdentityUser> _signInManager;//sisteme giriş-çıkışları yönetmek adına.
